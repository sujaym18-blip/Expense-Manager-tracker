...
const Budget = () => {
  ...
  const [formData, setFormData] = useState({ limit: '', category: '', month: selectedMonth });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ limit: '', category: '', month: selectedMonth });
      setShowForm(false);
          ...
          <div key={budget._id} className="card">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <h3 className="text-lg font-bold text-dark">{budget.category.name}</h3>
              </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-gray-600 mt-1">
                  {budget.percentageSpent.toFixed(1)}% of ${budget.limit.toFixed(2)}
                </p>
              </div>

              <div className="flex justify-between pt-2 border-t">
                <span className="text-sm text-gray-600">Remaining</span>
                <span className={`font-bold ${budget.remaining >= 0 ? 'text-secondary' : 'text-danger'}`}>
