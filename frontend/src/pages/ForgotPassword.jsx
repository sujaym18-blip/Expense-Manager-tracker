  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      <div className="bg-white/5 backdrop-blur-md rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/10">
        ...
        {!submitted ? (
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              <div>
                <label className="label-field text-gray-300">
                  Email Address
                </label>
        ...
        <Link
          to="/login"
          className="flex items-center justify-center gap-2 text-blue-400 hover:text-blue-300 font-medium mt-6 transition"
        >
          <ArrowLeft size={18} />
          Back to Login
        </Link>
